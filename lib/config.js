...
export default function(date) {
    ...
    let applyDefaults = function(defaults, target) {
        for (let k in defaults) {
            ...
            if (current == null) {
                ...
                let removes = {};
                let iterable = __range__(current.length-1, 0, true);
    ...
    // set static function
    module.exports.gravatarUrlFromName = gravatarUrlFromName = function(name) {
...
function gravatarUrlFromName$1(name) {
    if (gravatarUrlFromName == null) {
        // load some default config to init fn
        let moment = require('moment');
        module.exports(moment());
    }
    return gravatarUrlFromName(name);
}
export { gravatarUrlFromName$1 as gravatarUrlFromName };
